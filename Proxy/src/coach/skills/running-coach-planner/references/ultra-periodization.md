...
Schedule back-to-back long runs only when all three hold:
...
When any gate trips, downgrade the next hard session to easy and add a safety flag:

- training readiness below 30
